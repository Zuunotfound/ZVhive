...
router.post('/posts', authenticateFirebaseToken, ensureAccount, async (req: any, res) => {
...
router.post('/posts/:id/comments', authenticateFirebaseToken, ensureAccount, async (req: any, res) => {
  const postId = req.params.id;
