...
// Series CRUD (admin)
router.post('/series', authenticateFirebaseToken, requireRole('admin'), async (req, res) => {
...
router.post('/series/:id/chapters', authenticateFirebaseToken, requireRole('admin'), async (req, res) => {
